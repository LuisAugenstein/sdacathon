...
def get_tasksets():
    ...
    train_tasks = TensorTask(os.path.join(
        current_dir, 'data/meta-train/pretrain'))
    validation_tasks = TensorTask(
        os.path.join(current_dir, 'data/meta-train/validation'))
    test_adaptation_tasks = TensorTask(
        os.path.join(current_dir, 'data/meta-test/train'))
    test_evaluation_tasks = TensorTask(
        os.path.join(current_dir, 'data/meta-test/test'))
